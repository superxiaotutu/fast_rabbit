...
def attack(model, imgs_input, imgs_label, type, ):
        # adv_node
        shuff_dir = {}
    ...
    with open('cnn_result.txt', 'w')as f:
        for type in range(4):
            ...
            for epoch in range(file_count // batch_size):
                ...
                imgs_input_after = attack(model, imgs_input, imgs_label, 'cnn')
    ...
    with open('ocr_result.txt', 'w')as f:
        ...
        for type in range(4):
            ...
            for epoch in range(file_count // batch_size):
                ...
                distance, cost_time,imgs_input_after = attack(model, imgs_input, imgs_label, 'ocr')
